...
# Actualizar a MS Windows 11 en maquina virtual KVM Linux
...
Ejecutar 'regedit' desde la ventana "ejecutar", que abrira el [registro](https://es.wikipedia.org/wiki/Registro_de_Windows) de Windows,
...
crear nueva clave llamada "LabConfig"

dentro de LabConfig, crea un DWORD (32-bit) con los siguientes valores :
...
Apaga todas las Maquinas Virtuales en ejecución y deten el módulo **kvm_probe** con el siguiente comando:
...
Ahora procede con la actualización a Windows 11 desde Windows Update (“Buscar actualizaciones”).
El sistema debería omitir las restricciones habituales y comenzar la actualización a Windows 11.
